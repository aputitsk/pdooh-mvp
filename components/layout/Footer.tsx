        ...
        <nav aria-label="Arc resources" className="flex items-center gap-2">
          {arcLinks.map((link) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 text-xs font-medium text-neutral-400 transition hover:border-[#4F8CFF]/35 hover:bg-[#10284D]/35 hover:text-white"
            >
              {link.label}
            </a>
          ))}
